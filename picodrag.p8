...
function make_track()
 ...
 add(track.cells, {14,7,29})
 add(track.cells, {14,6,11})
 add(track.cells, {14,5,11})
 add(track.cells, {14,4,11})
 add(track.cells, {14,3,11})
 add(track.cells, {14,2,13})
 add(track.cells, {13,2,10})
 add(track.cells, {12,2,10})
 add(track.cells, {11,2,10})
 add(track.cells, {10,2,10})
 add(track.cells, {9,2,10})
 add(track.cells, {8,2,28})
 add(track.cells, {8,1,13})
 add(track.cells, {7,1,10})
 add(track.cells, {6,1,10})
 add(track.cells, {5,1,10})
 add(track.cells, {4,1,10})
 add(track.cells, {3,1,12})
 add(track.cells, {3,2,28})
 add(track.cells, {4,2,10})
 add(track.cells, {5,2,10})
 add(track.cells, {6,2,13})
 add(track.cells, {6,3,11})
 add(track.cells, {6,4,29})
 add(track.cells, {5,4,10})
 add(track.cells, {4,4,10})
 add(track.cells, {3,4,10})
 add(track.cells, {2,4,10})
 add(track.cells, {1,4,12})
 add(track.cells, {1,5,11})
 add(track.cells, {1,6,11})
 add(track.cells, {1,7,28})
 add(track.cells, {2,7,10})
 add(track.cells, {3,7,29})
 add(track.cells, {3,6,11})
...
__gfx__

...

__map__

